...
TRANSLATIONS = {
    "en": {
        ...
        "effects_heading": "Visual effects",
        "effects_sub": "Turn off individually on a weak board to cut CPU/GPU load.",
        "fx_glass_label": "Frosted glass effect on cards",
        "fx_scan_label": "Rotating scan ring on cards",
        "fx_flash_label": "Flash animation on price change",
        "fx_glow_label": "Price glow pulse",
    ...
    "ar": {
        ...
        "effects_heading": "التأثيرات المرئية",
        "effects_sub": "عطّل كل تأثير على حدة على الأجهزة الضعيفة لتقليل استهلاك المعالج.",
        "fx_glass_label": "تأثير الزجاج المصنفر على البطاقات",
        "fx_scan_label": "حلقة المسح الدوارة على البطاقات",
        "fx_flash_label": "تأثير الوميض عند تغيّر السعر",
        "fx_glow_label": "توهج السعر النابض",
